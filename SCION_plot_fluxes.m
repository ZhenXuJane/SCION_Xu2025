...
%%%% Legend
text(-250,2.4,'D','color','r')
text(-250,2.2,'E','color','g')
text(-250,2,'W','color','b')
text(-250,1.8,'B','color','m')
text(-250,1.6,'BA','color','k')
text(-250,1.4,'GA','color',[0.8 0.8 0.8])
%%%% Title
title('Forcings')
...
%%%% Legend
text(-250,1.9e12,'mpsb','color','k')
text(-250,1.7e12,'mgsb','color','c')
...
%%%% Legend
text(-250,1.5,'VEG','color','g')
text(-250,1.25,'G','color','k')
text(-250,1,'C','color','c')
%%%% Title
title('C reservoirs')
...
%%%% Legend
text(-250,1,'PYR','color','k')
text(-250,0.9,'GYP','color','c')
%%%% Title
title('S reservoirs')
...
%%%% Legend
text(-250,1.5,'P','color','b')
text(-250,1,'N','color','g')
%%%% Title
