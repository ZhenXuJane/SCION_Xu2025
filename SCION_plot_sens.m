...
%%%% plot VEG
plot((sens.time_myr),mean(sens.VEG,2),'linewidth',1,'color',c_mean)
plot((sens.time_myr),max(sens.VEG,[],2),'linewidth',0.5,'color',c_range)
plot((sens.time_myr),min(sens.VEG,[],2),'linewidth',0.5,'color',c_range)
